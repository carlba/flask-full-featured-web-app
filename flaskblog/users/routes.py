...
from flaskblog.users.utilities import save_picture, send_reset_email
...
@users.route('/account', methods=['GET', 'POST'])  # wrong order will not enable the login_required decorator
@login_required
def account():
